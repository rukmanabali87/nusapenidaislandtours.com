                ...
                <div className="grid grid-cols-1">
                    <div className="flex flex-col min-h-screen justify-center md:px-10 py-10 px-4">
                        <div className="text-center">
                            <Link href="/"><Image src='/images/logo-nusa-penida-icon.png' width={112} height={112} className="mx-auto" alt=""/></Link>
                        </div>
                        <div className="title-heading text-center my-auto">
                            <Image src='/images/maintenance-3d.png' width={0} height={0} sizes="100vw" style={{width:'384px', height:'auto'}} className="mx-auto w-96" alt=""/>
